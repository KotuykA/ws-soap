...
public interface GeoIPServiceSoap {
     ...
     * @param ipAddress
     * @return
     *     returns com.geoipservice.GeoIP
     */
    ...
    @RequestWrapper(localName = "GetGeoIP", targetNamespace = "http://www.webservicex.net/", className = "com.geoipservice.GetGeoIP")
    @ResponseWrapper(localName = "GetGeoIPResponse", targetNamespace = "http://www.webservicex.net/", className = "com.geoipservice.GetGeoIPResponse")
    ...
    public GeoIP getGeoIP(
            @WebParam(name = "IPAddress", targetNamespace = "http://www.webservicex.net/")
                    String ipAddress,
            @WebParam(name = "dns", targetNamespace = "http://www.webservicex.net/")
                    String dns);
    /**
    ...
    @RequestWrapper(localName = "GetGeoIPContext", targetNamespace = "http://www.webservicex.net/", className = "com.geoipservice.GetGeoIPContext")
    @ResponseWrapper(localName = "GetGeoIPContextResponse", targetNamespace = "http://www.webservicex.net/", className = "com.geoipservice.GetGeoIPContextResponse")
